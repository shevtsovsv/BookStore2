...
# Актуальные особенности интерфейса

В текущей реализации:

- Все формы используют динамические классы `.valid` и `.invalid` для обратной связи.
- Сообщения об ошибках появляются только при ошибке, скрываются автоматически.
